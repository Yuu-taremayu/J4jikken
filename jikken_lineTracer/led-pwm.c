     ...
     /* この関数はタイマ割り込み0の割り込みハンドラから呼び出される */
{
  ...
  lcd_str_upper[4] = redval / 100 + '0';
  lcd_str_upper[5] = (redval / 10) % 10 + '0';
  lcd_str_upper[6] = redval % 10 + '0';
  lcd_str_upper[7] = '\0';

  
  greenval = ad_read(2);

  lcd_str_lower[6] = greenval / 100 + '0';
  lcd_str_lower[7] = (greenval / 10) % 10 + '0';
  lcd_str_lower[8] = greenval % 10 + '0';
  lcd_str_lower[9] = '\0';
}
